...
class MP3ScreenController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var audioRateLabel: UILabel! //8000hz
    ...
    @IBAction func convertButtonTapped(_ sender: UIButton) {
        ...
        convertVideoToMP3(videoURL: videoURL, audioRate: selectedAudioRate, audioMode: selectedAudioMode)
    }
    
    func convertVideoToMP3(videoURL: URL, audioRate: String, audioMode: String) {
